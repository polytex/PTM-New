<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="ReportClients.aspx.cs" Inherits="ReportClients" %>
...
<Polytex:ObjectDataSource ID="ObjectDataSource1" runat="server" IsEmpty="False" SelectMethod="Clients" TypeName="PolytexData.ReportsTasks" OnInit="ObjectDataSource1_Init">
    <SelectParameters>        
    ...
    <Columns>
        <asp:TemplateField>
         ...
         <asp:TemplateField>
            ...
            <ItemTemplate>
                <asp:Label ID="LabelClient" runat="server" Text='<%# Bind("CLIENT_NAME") %>' />
            </ItemTemplate>                        
        </asp:TemplateField>
        ...
        <asp:TemplateField>
            ...
            <FooterTemplate>
                <asp:Label ID="LabelTotal" runat="server" Text='<%# GetTotalHours() %>'></asp:Label>
            </FooterTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField>
            ...
            <ItemTemplate>
                <asp:Label ID="Total" runat="server" Text='<%# Bind("COUNT_ACTIVITIES") %>'></asp:Label>
            </ItemTemplate> 
          <FooterTemplate>
                <asp:Label ID="LabelTotal" runat="server" CssClass="GridFooterContent" Text='<%# GetTotalActivities() %>'></asp:Label>
          </FooterTemplate>                    
        </asp:TemplateField>
        
        <asp:TemplateField ShowHeader="False">               
           <ItemTemplate>
               <Polytex:CustomImageButton ID="CustomImageButtonFind" CustomButtonType="Search"  runat="server" CommandName="ClientId" CommandArgument='<%# Bind("CLIENT_ID") %>' MouseEffect="True" ImageAlign="Right" />
           </ItemTemplate>                      
