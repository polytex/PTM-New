<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="ReportActivityType.aspx.cs" Inherits="ReportActivityType" Title="Untitled Page" %>
...
<Polytex:ObjectDataSource ID="ObjectDataSource1" runat="server" IsEmpty="False" SelectMethod="ActivityType" TypeName="PolytexData.ReportsTasks" OnInit="ObjectDataSource1_Init">
    <SelectParameters>        
    ...
    <Columns>
        <asp:TemplateField>
         ...
         <asp:TemplateField>
            ...
            <ItemTemplate>
                <asp:Label ID="LabelClient" runat="server" Text='<%# Bind("ACTIVITY_GROUP_NAME") %>'></asp:Label>
            </ItemTemplate>                        
        </asp:TemplateField>
       ...
       <asp:TemplateField>
            ...
            <ItemTemplate>
                <asp:Label ID="LabelActivityType" runat="server" Text='<%# Bind("ACTIVITY_TYPE_NAME") %>' />
            </ItemTemplate>                        
        </asp:TemplateField>
        ...
        <asp:TemplateField>
         ...
         <asp:TemplateField ShowHeader="False">               
           <ItemTemplate>
               <Polytex:CustomImageButton ID="CustomImageButtonFind" CustomButtonType="Search" runat="server" ImageAlign="Right" CommandName="ActivityTypeId" CommandArgument='<%# Bind("ACTIVITY_TYPE_ID") %>' MouseEffect="True" />
           </ItemTemplate>                      
