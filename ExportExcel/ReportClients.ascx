<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportClients.ascx.cs" Inherits="ExportExcel_ReportClients" %>

<Polytex:ObjectDataSource ID="ObjectDataSource1" runat="server" IsEmpty="False" SelectMethod="Clients" TypeName="PolytexData.ReportsTasks">
    <SelectParameters>        
