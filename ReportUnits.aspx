<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="ReportUnits.aspx.cs" Inherits="ReportUnits" Title="Untitled Page" %>
...
<Polytex:ObjectDataSource ID="ObjectDataSource1" runat="server" IsEmpty="False" SelectMethod="Units" TypeName="PolytexData.ReportsTasks" OnInit="ObjectDataSource1_Init">
    <SelectParameters>        
...
<tr>
    ...
    <Columns>
        ...
        <asp:TemplateField>
            ...
            <ItemTemplate>
                <asp:Label ID="LabelUnit" runat="server" Text='<%# Bind("UNIT_NAME") %>'/>
            </ItemTemplate>                        
        </asp:TemplateField>
        ...
        <asp:TemplateField ShowHeader="False">               
           <ItemTemplate>
               <Polytex:CustomImageButton ID="CustomImageButtonFind"  CustomButtonType="Search"  runat="server" ImageAlign="Right" CommandName="UnitId" CommandArgument='<%# Bind("UNIT_ID") %>' MouseEffect="True" />
           </ItemTemplate>                      
