<%@ Page Language="C#" MasterPageFile="~/Popups/Popups.master" AutoEventWireup="true" CodeFile="ReportActivityType.aspx.cs" Inherits="Popups_ReportActivityType" Title="Untitled Page" %>
...
<div class="DivReportPopup" style="<%=PolyPage.IsMobile ? "height:226px;width:278px" : "height:305px;" %>">
    ...
    <tr style="height:28px;">                                
        <td>
            ...
            <tr>        
                <td style="vertical-align:top;"><div style="padding-top:6px"><Polytex:Label ID="Label1" runat="server" Trans="Territory"></Polytex:Label>:&nbsp;&nbsp;</div></td>
                <td>
            ...
            <tr>        
                <td style="vertical-align:top;"><div style="padding-top:6px"><Polytex:Label ID="LabelTerritory" runat="server" Trans="ActivityGroupName"></Polytex:Label>:&nbsp;&nbsp;</div></td>
                <td>
                    <Polytex:DropDownList ID="DropDownListActivityGroupId" runat="server" DropDownListWidth="170px" DataSourceID="ObjectDataSourceActivityGroups" DataTextField="NAME" DataValueField="ID" InsertEmptyItem="true" IsRequired="false" ValidationGroup="ReportQuery" ValidatorsPosition="Vertical"></Polytex:DropDownList>
                </td>
            </tr>
            <tr>        
